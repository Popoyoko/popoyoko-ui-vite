...
function Ut() {
  if (st)
    return g;
  st = 1;
  var O = Symbol.for("react.element"), v = Symbol.for("react.portal"), pe = Symbol.for("react.fragment"), q = Symbol.for("react.strict_mode"), te = Symbol.for("react.profiler"), Q = Symbol.for("react.provider"), ne = Symbol.for("react.context"), Z = Symbol.for("react.forward_ref"), L = Symbol.for("react.suspense"), ee = Symbol.for("react.memo"), N = Symbol.for("react.lazy"), U = Symbol.iterator;
  function re(n) {
  ...
  var he = F.prototype = new oe();
  he.constructor = F, ce(he, ae.prototype), he.isPureReactComponent = !0;
  var ue = Array.isArray, M = Object.prototype.hasOwnProperty, H = { current: null }, fe = { key: !0, ref: !0, __self: !0, __source: !0 };
  function ve(n, s, h) {
    var C, _ = {}, k = null, j = null;
    if (s != null)
      for (C in s.ref !== void 0 && (j = s.ref), s.key !== void 0 && (k = "" + s.key), s)
        M.call(s, C) && !fe.hasOwnProperty(C) && (_[C] = s[C]);
    ...
    if (n && n.defaultProps)
      for (C in T = n.defaultProps, T)
        _[C] === void 0 && (_[C] = T[C]);
    return { $$typeof: O, type: n, key: k, ref: j, props: _, _owner: H.current };
  }
  function Re(n, s) {
  ...
  function J(n, s, h, C, _) {
    ...
    if (j)
      return j = n, _ = _(j), n = C === "" ? "." + G(j, 0) : C, ue(_) ? (h = "", n != null && (h = n.replace(we, "$&/") + "/"), J(_, s, h, "", function(V) {
        return V;
    ...
    if (j = 0, C = C === "" ? "." : C + ":", ue(n))
      ...
      for (n = w.call(n), T = 0; !(k = n.next()).done; )
        k = k.value, w = C + G(k, T++), j += J(k, s, h, w, _);
    else if (k === "object")
  ...
  return g.Children = { map: Y, forEach: function(n, s, h) {
    ...
    return n;
  } }, g.Component = ae, g.Fragment = pe, g.Profiler = te, g.PureComponent = F, g.StrictMode = q, g.Suspense = L, g.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = Se, g.cloneElement = function(n, s, h) {
    if (n == null)
    ...
    if (s != null) {
      ...
      for (w in s)
        M.call(s, w) && !fe.hasOwnProperty(w) && (C[w] = s[w] === void 0 && T !== void 0 ? T[w] : s[w]);
    }
    ...
    return n = { $$typeof: ne, _currentValue: n, _currentValue2: n, _threadCount: 0, Provider: null, Consumer: null, _defaultValue: null, _globalName: null }, n.Provider = { $$typeof: Q, _context: n }, n.Consumer = n;
...
function Bt() {
  return ct || (ct = 1, function(O, v) {
    process.env.NODE_ENV !== "production" && function() {
      ...
      Y.ReactDebugCurrentFrame = fe, Y.ReactCurrentActQueue = M;
      function ie(e) {
        {
      ...
      function Er(e, r, a) {
        ...
        if (r != null) {
          Ye(r) && (l = r.ref, P = H.current), ge(r) && (Oe(r.key), p = "" + r.key);
          var A;
      ...
      function be(e, r, a, o, i) {
        ...
        if (Fe(e))
          for (var vr = 0; vr < e.length; vr++)
            x = e[vr], I = z + Ae(x, vr), W += be(x, r, a, I, i);
        else {
          var Lr = F(e);
          if (typeof Lr == "function") {
            ...
            for (var Lt = Lr.call(ot), ut, Nt = 0; !(ut = Lt.next()).done; )
              x = ut.value, I = z + Ae(x, Nt++), W += be(x, r, a, I, i);
          } else if (p === "object") {
            var it = String(e);
...
Your code should look like: 
  const MyComponent = lazy(() => import('./MyComponent'))`, i), i.default;
      ...
      function u(e) {
        return !!(typeof e == "string" || typeof e == "function" || e === Q || e === Z || J || e === ne || e === U || e === re || G || e === Ie || Ce || Ue || we || typeof e == "object" && e !== null && (e.$$typeof === ce || e.$$typeof === K || e.$$typeof === L || e.$$typeof === ee || e.$$typeof === N || // This needs to include all possible module reference object
...
Check the top-level render call using <` + a + ">.");
      ...
      function rt(e, r, a) {
        ...
        if (!o) {
          ...
          p ? i += p : i += Jr();
          var l;
          e === null ? l = "null" : Fe(e) ? l = "array" : e !== void 0 && e.$$typeof === q ? (l = "<" + (de(e.type) || "Unknown") + " />", i = " Did you accidentally export a JSX literal instead of a component?") : l = typeof e, d("React.createElement: type is invalid -- expected a string (for built-in components) or a class/function (for composite components) but got: %s.%s", l, i);
        }
      ...
      v.Children = $t, v.Component = _, v.Fragment = Q, v.Profiler = Z, v.PureComponent = V, v.StrictMode = ne, v.Suspense = U, v.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = Y, v.cloneElement = It, v.createContext = ur, v.createElement = Dt, v.createFactory = Ft, v.createRef = hr, v.forwardRef = kr, v.isValidElement = _e, v.lazy = Pr, v.memo = c, v.startTransition = jt, v.unstable_act = xt, v.useCallback = X, v.useContext = R, v.useDebugValue = se, v.useDeferredValue = yt, v.useEffect = B, v.useId = ht, v.useImperativeHandle = ir, v.useInsertionEffect = D, v.useLayoutEffect = $, v.useMemo = Ee, v.useReducer = b, v.useRef = m, v.useState = S, v.useSyncExternalStore = mt, v.useTransition = vt, v.version = pe, typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ < "u" && typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStop == "function" && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStop(new Error());
    }();
  }(Yt, Ke)), Ke;
}
var ft;
...
function zt() {
  if (lt)
    return He;
  lt = 1;
  var O = pt(), v = Symbol.for("react.element"), pe = Symbol.for("react.fragment"), q = Object.prototype.hasOwnProperty, te = O.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, Q = { key: !0, ref: !0, __self: !0, __source: !0 };
  function ne(Z, L, ee) {
    var N, U = {}, re = null, K = null;
    ee !== void 0 && (re = "" + ee), L.key !== void 0 && (re = "" + L.key), L.ref !== void 0 && (K = L.ref);
    for (N in L)
      q.call(L, N) && !Q.hasOwnProperty(N) && (U[N] = L[N]);
    if (Z && Z.defaultProps)
      for (N in L = Z.defaultProps, L)
        U[N] === void 0 && (U[N] = L[N]);
    return { $$typeof: v, type: Z, key: re, ref: K, props: U, _owner: te.current };
  }
...
function qt() {
  return dt || (dt = 1, process.env.NODE_ENV !== "production" && function() {
    var O = pt(), v = Symbol.for("react.element"), pe = Symbol.for("react.portal"), q = Symbol.for("react.fragment"), te = Symbol.for("react.strict_mode"), Q = Symbol.for("react.profiler"), ne = Symbol.for("react.provider"), Z = Symbol.for("react.context"), L = Symbol.for("react.forward_ref"), ee = Symbol.for("react.suspense"), N = Symbol.for("react.suspense_list"), U = Symbol.for("react.memo"), re = Symbol.for("react.lazy"), K = Symbol.for("react.offscreen"), ce = Symbol.iterator, Ie = "@@iterator";
    function ae(t) {
    ...
    var ue = !1, M = !1, H = !1, fe = !1, ve = !1, Re;
    Re = Symbol.for("react.module.reference");
    function Ce(t) {
      return !!(typeof t == "string" || typeof t == "function" || t === q || t === Q || ve || t === te || t === ee || t === N || fe || t === K || ue || M || H || typeof t == "object" && t !== null && (t.$$typeof === re || t.$$typeof === U || t.$$typeof === ne || t.$$typeof === Z || t.$$typeof === L || // This needs to include all possible module reference object
      // types supported by any Flight configuration anywhere since
      // we don't know which Flight build this will end up being used
      // with.
    ...
    var J = Object.assign, Y = 0, ie, d, le, Se, n, s, h;
    function C() {
    }
...
Check the top-level render call using <` + c + ">.");
    ...
    var Pr = Or, kr = Tr;
    Ge.Fragment = q, Ge.jsx = Pr, Ge.jsxs = kr;
  }()), Ge;
}
(function(O) {
...
const Ht = ({
  ...
  const Q = O ? "storybook-button--primary" : "storybook-button--secondary";
  return /* @__PURE__ */ Nr.jsx(
    "button",
    {
      type: "button",
      className: ["storybook-button", `storybook-button--${v}`, Q].join(
        " "
      ),
